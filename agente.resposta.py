...
st.markdown("<div style='background-color: #0E1117; padding: 10px; border-radius: 5px;'> <p style='color: #ADD8E6;'><b>AGENTE:</b> Qual a sua dúvida?</p> </div>", unsafe_allow_html=True)
